...
LSM:Register(MediaType_FONT, "Noodles",						[[Interface\Addons\SharedMedia\fonts\noodles\noodles.ttf]])
...
LSM:Register(MediaType_FONT, "Gotham Narrow Ultra",			[[Interface\Addons\SharedMedia\fonts\gotham_narrow_ultra\GothamNarrowUltra.otf]])
LSM:Register(MediaType_FONT, "Roboto Condensed",			[[Interface\Addons\SharedMedia\fonts\roboto_condensed\Roboto-Condensed.ttf]])
LSM:Register(MediaType_FONT, "Roboto Light",				[[Interface\Addons\SharedMedia\fonts\roboto_light\Roboto-Light.ttf]])
LSM:Register(MediaType_FONT, "Geo Sans Light",				[[Interface\Addons\SharedMedia\fonts\geo-sans-light\geo-sans-light.ttf]])
...
LSM:Register(MediaType_FONT, "Avantgarde",			[[Interface\Addons\SharedMedia\fonts\avantgarde\avantgarde.ttf]])
LSM:Register(MediaType_FONT, "Avantgarde Normal",			[[Interface\Addons\SharedMedia\fonts\avantgarde_normal\avantgarde_normal.ttf]])
LSM:Register(MediaType_FONT, "Vixar",			[[Interface\Addons\SharedMedia\fonts\vixar\vixar.ttf]])
LSM:Register(MediaType_FONT, "Buyan Reg",			[[Interface\Addons\SharedMedia\fonts\buyan_reg\buyan_reg.ttf]])
LSM:Register(MediaType_FONT, "Gotham Narrow Black",			[[Interface\Addons\SharedMedia\fonts\gotham_narrow_black\gotham_narrow_black.otf]])			
LSM:Register(MediaType_FONT, "Yellowjacket",				[[Interface\Addons\SharedMedia\fonts\yellowjacket\yellow.ttf]])
LSM:Register(MediaType_FONT, "Feeding a Moment",			[[Interface\Addons\SharedMedia\fonts\feeding_a_moment\feeding_a_moment.ttf]])
LSM:Register(MediaType_FONT, "Bebas Neue",				[[Interface\Addons\SharedMedia\fonts\bebas_neue\BebasNeue-Regular.ttf]])
-- -----
--   SOUND
-- -----
